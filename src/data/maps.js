export const MAPS = [
  {
    ...
    background: 0x1a2e1a,
    pathColor: 0x7a6040,
    waypoints: [[0,.57],[.06,.44],[.09,.46],[.141,.415],[.231,.503],[.286,.465],[.362,.579],[.392,.547],[.467,.572],[.608,.56],[.683,.61],[.693,.686],[.744,.704],[.814,.673],[.874,.585],[.915,.648],[1,.597]],
    startGold: 200,
    startLives: 25,
    unlockCost: 0,
    waveCount: 10,
  ...
  },
  {
    ...
    background: 0x1a0a00,
    pathColor: 0x8a3a1a,
    waypoints: [[0,.5],[.12,.44],[.22,.56],[.18,.72],[.32,.78],[.46,.7],[.48,.5],[.58,.38],[.7,.42],[.76,.6],[.88,.66],[1,.6]],
    startGold: 120,
    startLives: 15,
    unlockCost: 0,
    waveCount: 14,
